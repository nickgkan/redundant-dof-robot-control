'''
This function returns -dV/dq, where V is the criterion function that we
...
class SafetyCriterion():
    ...
    def _compute_link_slopes(self):
        '''link_slopes is a list of floats'''
        self.link_slopes = [
            compute_slope(
                self.jnts_x[jnt],
                self.jnts_y[jnt],
    ...
    def _compute_minimum_dist_per_link(self, x_obs, y_obs):
        '''minimum_dists_per_link is a list of (dist, point_type)'''
    ...
    def _compute_derivatives_of_dists_per_link(self, x_obs, y_obs):
        '''derivatives_of_dists_per_link is a list of arrays (8,)'''
